...
var ResultHolderComponent = (function () {
    ...
    ResultHolderComponent.prototype.getCreatedAucResults = function () {
        ...
        this.http.get("/completedAuctions", {})
            .subscribe(function (createdList) { return _this.createdList = createdList.json().reverse(); }, function () { return console.log(_this.createdList); }, function () { return _this.createdB = true; });
    };
    ResultHolderComponent.prototype.getWonAucResults = function () {
        var _this = this;
        this.http.get("/wonAuctions", {})
            .subscribe(function (wonList) { return _this.wonList = wonList.json().reverse(); }, function () { return console.log(_this.wonList); }, function () { return _this.won = true; });
    };
